...
export const userCredentialsStore = new Map<string, { apiKey?: string; model?: string }>();

// Helper to get or create AI service instance
export const getAiService = (aiService: AiService, model?: string, apiKey?: string): AiService => {
