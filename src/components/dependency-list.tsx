          ...
          >
            ...
            Object.keys(dependencies).length > 0 ? (
              Object.entries(dependencies).map(([tech, deps]) => (
                <CommandGroup
                  key={tech}
                  className="w-full my-2 gap-x-2"
                  role="group"
                  aria-label={`${tech} dependencies`}
                >
                  <button
              ...
              <div
                className="flex flex-row items-center justify-center gap-x-2 -translate-x-2"
                role="status"
                aria-live="polite"
              >
                <CommandEmpty>
              ...
              <CommandEmpty role="status" aria-label="No dependencies found">
